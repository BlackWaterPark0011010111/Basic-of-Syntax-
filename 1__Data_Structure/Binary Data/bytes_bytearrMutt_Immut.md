...
ord('A') будет возвращать кодовую точку число с ASCII кодом 65 и при обращении к байтовому обьекту по индексу(b'A'[0]) тоже получим 65.эти значения могут совпадать, но происхождение разное. ord оперирует абстрактными символами Unicode а индексация bytes сырыми данными.
